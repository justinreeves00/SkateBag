        ...
        <div className="bg-[#1c1c1e] border-b border-white/5 px-4 py-3 flex items-center justify-between shadow-2xl">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] text-slate-500 font-bold uppercase tracking-wider mt-0.5">Skateboard Tracker</span>
              <div className="flex items-center mt-0.5">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} width="8" height="8" viewBox="0 0 24 24" fill="currentColor" className="text-blue-400"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>
                ))}
              </div>
            </div>
          </div>
